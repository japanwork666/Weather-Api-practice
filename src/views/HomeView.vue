<template>
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      <input type="text" @input="getSearchResults" v-model="searchQuery" placeholder="Search for a city or state"
  ...
  queryTimeout.value = setTimeout(async () => {
    if (searchQuery.value !== "") {
      try {
        ...
        // 原始api url: https://api.mapbox.com/geocoding/v5/{endpoint}/{search_text}.json
