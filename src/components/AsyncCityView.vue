            ...
            <div class="mx-8 text-white">
                ...
                <div class="flex gap-10 overflow-x-scroll">
                    <div v-for="hourData in weatherData.hourly" :key="hourData.dt"
                        class="flex flex-col gap-4 iteems-center">
...
// 用 useRoute route 抓當前query的屬性資料
...
const getWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=${weatherAPIKey}&units=imperial`);
